...
void dump_table(void *table_base, char *out_file)
{
    ...
    for (flow_idx = 0 ; flow_idx < PNA_FLOW_ENTRIES; flow_idx++ ) {
		...
		//OSF information I tacked on, should find a better way to log stuff
		//88 Test:
		/*
		log->osf.tcp_sig.opt_hash = 88;
		log->osf.tcp_sig.quirks = 88;
		log->osf.tcp_sig.opt_eol_pad = 88;
		log->osf.tcp_sig.ip_opt_len = 88;
		log->osf.tcp_sig.ip_ver = 88;
		log->osf.tcp_sig.ttl = 88;
		log->osf.tcp_sig.mss = 88;
		log->osf.tcp_sig.win = 88;
		log->osf.tcp_sig.win_type = 88;
		log->osf.tcp_sig.wscale = 88;
		log->osf.tcp_sig.pay_class = 88;
		log->osf.tcp_sig.tot_hdr = 88;
		log->osf.tcp_sig.ts1 = 88;
		log->osf.tcp_sig.recv_ms = 88;
		log->osf.tcp_mat.type = 88;
		*/		
		/*
